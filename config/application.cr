...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Poc Chat Amber web application."
  #
  #
  ...
  #
  # settings.secret_key_base= w3cC-V2S7PAc2cdyDorUPf0CBBrwoSMppaMb9M7C_8I
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("poc-chat-amber.log", "w"))
  #
  #
end
